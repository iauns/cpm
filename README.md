...
```cmake
  ...
  include(CPMSetup.cmake) # download and initialize CPM
...
To use CPM in your C++ project, download
[`CPMSetup.cmake`](https://github.com/iaun/cpm/blob/master/CPMSetup.cmake)
to the root of your project:
```bash
wget https://github.com/iaun/cpm/blob/master/CPMSetup.cmake
```
and then paste the following code at the top of your `CMakeLists.txt`:

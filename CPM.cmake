...
if (DEFINED CPM_UNIQUE_ID)
  ...
  set(CPM_PARENT_NS_DIRECTIVE "\n#define CPM_NAMESPACE\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}#define CPM_IN_PARENT_DIRECTIVE\n")
else()
  set(CPM_NS_HEADER_FILE "${CPM_DIR_OF_CPM}/include/cpm/cpm.h")
  set(CPM_INCLUDE_DIRS "${CPM_DIR_OF_CPM}/include")
  # We don't undefine CPM_NAMESPACE in the parent.
  set(CPM_PARENT_NS_DIRECTIVE "\n                          #define CPM_IN_PARENT_DIRECTIVE\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}  #define CPM_NAMESPACE \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}    #ifndef ${CPM_UNIQUE_ID}##_cpm_def \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}      #define ${CPM_UNIQUE_ID}##_cpm_def \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}      namespace ${CPM_UNIQUE_ID} { \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}    #else \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}      #undef ${CPM_UNIQUE_ID}##_cpm_def \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}      } \\\n")
  set(CPM_PARENT_NS_DIRECTIVE "${CPM_PARENT_NS_DIRECTIVE}    #endif \n")
endif()

function(_cpm_write_include_header incFile uniqueID)
  file(APPEND ${incFile} "// This file was automatically generated by CPM.\n")
  file(APPEND ${incFile} "// It includes all automatically generated namespaces.\n\n")
  #file(APPEND ${CPM_NS_HEADER_FILE} "#ifndef __CPM__CPM__HEADER_H_\n")
  #file(APPEND ${CPM_NS_HEADER_FILE} "#define __CPM__CPM__HEADER_H_\n\n")
  file(APPEND ${incFile} "#ifndef CPM_NAMESPACE_NAME\n")
  # We are either a top level.
  # Define a dummy namespace preprocessor definition
  # that will undefine CPM_NAMESPACE when a second occurance appears.
  file(APPEND ${incFile} "  #define CPM_NAMESPACE \\\n")
  file(APPEND ${incFile} "    #ifndef ${uniqueID}_cpm_def \\\n")
  file(APPEND ${incFile} "      #define ${uniqueID}_cpm_def \\\n")
  file(APPEND ${incFile} "    #else \\\n")
  file(APPEND ${incFile} "      #undef CPM_NAMESPACE \\\n")
  file(APPEND ${incFile} "      #undef ${uniqueID}_cpm_def \\\n")
  file(APPEND ${incFile} "    #endif \n")
  file(APPEND ${incFile} ${CPM_PARENT_NS_DIRECTIVE})
  file(APPEND ${incFile} "#else\n")
  file(APPEND ${incFile} "  #undef CPM_NAMESPACE\n")
  file(APPEND ${incFile} "")
  file(APPEND ${incFile} "  #define CPM_NAMESPACE \\\n")
  file(APPEND ${incFile} "    #ifndef CPM_NAMESPACE_NAME##_def \\\n")
  file(APPEND ${incFile} "      #define CPM_NAMESPACE_NAME##_def \\\n")
  file(APPEND ${incFile} "      namespace CPM_NAMESPACE_NAME { \\\n")
  file(APPEND ${incFile} "    #else \\\n")
  file(APPEND ${incFile} "      #undef CPM_NAMESPACE \\\n")
  file(APPEND ${incFile} "      #undef CPM_NAMESPACE_NAME##_def \\\n")
  file(APPEND ${incFile} "      #define CPM_NAMESPACE #error CPM_NAMESPACE not defined here.\\\n")
  file(APPEND ${incFile} "      } \\\n")
  file(APPEND ${incFile} "    #endif\n")
  file(APPEND ${incFile} "#endif\n\n")
...
_cpm_write_include_header(${CPM_NS_HEADER_FILE})

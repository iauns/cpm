...
file(APPEND ${CPM_NS_HEADER_FILE} "#ifndef CPM_NAMESPACE_NAME\n")
# Define a dummy namespace preprocessor definition
# that will undefine CPM_NAMESPACE when a second occurance appears.
file(APPEND ${CPM_NS_HEADER_FILE} "  #define CPM_NAMESPACE\n")
file(APPEND ${CPM_NS_HEADER_FILE} "#else\n")
file(APPEND ${CPM_NS_HEADER_FILE} "  #undef CPM_NAMESPACE\n")
file(APPEND ${CPM_NS_HEADER_FILE} "  #define CPM_NAMESPACE \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "    #ifndef CPM_NAMESPACE_NAME##_def \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "      #define CPM_NAMESPACE_NAME##_def \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "      namespace CPM_NAMESPACE_NAME { \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "    #else \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "      #undef CPM_NAMESPACE \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "      #undef CPM_NAMESPACE_NAME##_def \\\n")
file(APPEND ${CPM_NS_HEADER_FILE} "      #define CPM_NAMESPACE #error CPM_NAMESPACE not defined here.\\\n")
